  ...
  >
    <div class="container">
      ...
      <div class="convictions">
        <article>
          <p class="eyebrow">Simplicité</p>
          <blockquote>
            « Une bonne solution ne devrait pas paraître plus compliquée que le
        ...
        <article>
          ...
          <blockquote>
            « Une fonctionnalité n’a de valeur que si elle est réellement
            adoptée. »
          </blockquote>
        </article>
        <article>
          ...
          <blockquote>
            « La qualité naît du dialogue entre utilisateurs, métier et
            technique. »
          </blockquote>
        </article>
      </div>
