    ...
    <div class="container">
      <div class="value-intro">
        ...
        <div class="value-intro-copy">
          ...
          <p>
            ...
            métiers pour comprendre leurs contraintes. Je garde l’usage au
            centre, du premier échange à la mise en production.
          </p>
        </div>
      </div>
      <div class="value-columns">
        ...
        <article data-reveal>
          ...
          <ul>
            <li>Priorisation & coordination</li>
            <li>Delivery</li>
            <li>Adoption</li>
          </ul>
        </article>
